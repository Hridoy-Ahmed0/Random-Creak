...
def innocent():
    ...
    print('Ok Ids Saved in /HRIDOY-OK.txt')

    print('Cp Ids Saved in /HRIDOY-CP.txt')
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\r\033[1;32m[HRIDOY-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                if 'y' in cp_cpx: 
                 ...
                 print('\r\r\033[1;30m[HRIDOY-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
        ...
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mHRIDOY\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
